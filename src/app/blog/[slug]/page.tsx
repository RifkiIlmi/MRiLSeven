    ...
    <article className="max-w-3xl mx-auto py-10">
      <header className="mb-12">
        ...
        <div className="flex items-center gap-4 mb-10">
          <div className="w-12 h-12 rounded-full bg-gray-100 flex items-center justify-center text-xl shadow-inner">👤</div>
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-2 text-sm text-gray-500">
              ...
              <span className="flex items-center gap-1">
                <span className="text-gray-400">👁️</span> {post.views || 0} views
              </span>
              <span>·</span>
              <span>
      ...
      <div className="mt-20 pt-10 border-t border-gray-100 flex flex-wrap gap-2">
        {['Teknologi', 'Programming', 'Web'].map(tag => (
          <span key={tag} className="bg-gray-50 px-4 py-2 rounded-full text-sm text-gray-600">
            {tag}
          </span>
        ))}
      </div>
